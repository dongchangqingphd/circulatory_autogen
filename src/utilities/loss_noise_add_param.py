...
params_dir = "/people/cdon822/changqing/circulatory_autogen-devel/resources/"
...
print("[debug]current_ratio=",current)

#save process data
with open("right_calibrated_log.csv", "w", newline='') as f:
    writer = csv.writer(f)
    writer.writerow(["pv","current", "pred1", "pred2", "cost"]) 
