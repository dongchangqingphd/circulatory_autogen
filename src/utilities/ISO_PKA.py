...
file_path = "/home/cdon822/Documents/GIT_files/circulatory_autogen/generated_models/calibrated5/calibrated5.cellml"
...
obs_list = ['NES/ISO_init','Ifg/PKA_out2']
str_title = "ISO-PKA relationship"
...
save_addr1 = Outputfile_address + "/"+save_newfilename1+"/ISO_PKA-fit Yaniv_2015_1.png"
...
x1 = [0.1,0.2,0.4,1,10,20,100,1000]
y1 = [0.0025,0.3964,0.5,0.705,0.85,0.8751,0.993,1.01]
yerr = [0.1,0.167,0.1,0.088,0.113,0.062,0.094,0.006]
