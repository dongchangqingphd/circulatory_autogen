...
def compute_peak_period(timeline,V_data):
    ...
    # only use 5s later data, steady-state
    mask = timet >= 5.0
    time = timet[mask]
    signal = voltage[mask]
...
file_path = "/home/cdon822/Documents/GIT_files/circulatory_autogen/generated_models/SANHR7/SANHR7.cellml"
...
str_title = "ISO - b1-AR relationship"
...
obs_list = ['NES/ISO_init','NES/beta1_actived']
...
for ii in range(1,29):
    ...
    reset_param_val[0] = reset_param_val[0]*1.6
    ...
    #outputs = z1.copy()
    print("ISO=",reset_param_val[0],z1)
...
save_addr1 = Outputfile_address + "/"+save_newfilename1+"/ISO_HR-test_beta1_actived.png"
#save_addr2 = Outputfile_address + "/"+save_newfilename1+"/CCh_HR-SANHR14.png"

plt.plot(NEs,outy,marker='.',linestyle='-',color='g')
...
plt.ylabel('beta1_actived  value')
plt.grid(False)
