...
# TODO 
#preset some address, such as input model address
model_path = "/home/cdon822/Documents/GIT_files/circulatory_autogen/module_config_user/NESAN_modules.cellml"
config_path = "/home/cdon822/Documents/GIT_files/circulatory_autogen/module_config_user/module_config.json"
...
obs_list = ['Rate_modulation_experiments/ISO','Rate_modulation_experiments/cAMP_nif']
...
plt.plot(inputs,outputs,marker='.',linestyle='-',color='b',label='simulation')
#plt.title(str_title)
plt.xscale('log')
