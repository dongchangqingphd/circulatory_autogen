...
#file_path = "/home/cdon822/Documents/GIT_files/circulatory_autogen/generated_models/SANHR14/SANHR14.cellml"
#Outputfile_address = "/home/cdon822/Documents/GIT_files/my_project/simulation results/SAN_model"
file_path = "/home/cdon822/Documents/GIT_files/CA_user/NEs_to_SAN/generated_models/NSAN2/NSAN2.cellml"
Outputfile_address = "/home/cdon822/Documents/GIT_files/CA_user/NEs_to_SAN/simulation_results"
#create a new temporary files to save the results
save_newfilename1 = "rabbit_SANC"
...
for ii in range(1,100):
    ...
    reset_param_val[0] = reset_param_val[0]+0.02
...
save_addr1 = Outputfile_address + "/"+save_newfilename1+"/ISO_HR-NSAN2_a5.png"
#save_addr2 = Outputfile_address + "/"+save_newfilename1+"/CCh_HR-SANHR14.png"

plt.plot(NEs,HRf2,marker='.',linestyle='-',color='g')
#plt.plot(NEs,HRf2,marker='.',linestyle='-',color='g',label='calibrated')
plt.title(str_title)
#plt.xscale('log')
#plt.xticks([0, 10, 20, 30, 40], labels=["0.1", "1", "10", "100", "1000"])

#add error bar in curve
x1 = [0.1,0.5,1]
y1 = [75.9,90.62,100]
yerr = [9.576,8.855,9.332]
...
plt.errorbar(x1,y_err,yerr=yerr_err,fmt='x', capsize=5,color='red')
