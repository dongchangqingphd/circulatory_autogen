...
file_path = "/home/cdon822/Documents/OpenCOR/NESAN-rabbit2.cellml"
...
for ii in range(1,60):
    ...
    reset_param_val[0] = reset_param_val[0]+0.5
...
save_addr1 = Outputfile_address + "/"+save_newfilename1+"/ISO_HR-R2-TESTEQ.png"
